...
--
-- Host: localhost:3306
-- Generation Time: Nov 27, 2021 at 04:24 AM
...
INSERT INTO `account` (`id`, `fullname`, `username`, `password`, `role_id`, `created_at`) VALUES
(1, 'Phan Anh Tú', 'tu', '81dc9bdb52d04dc20036dbd8313ed055', 1, '2021-11-08 14:13:17'),
(3, 'aasdd3', 'luciferx200133', '4297f44b13955235245b2497399d7a93', 2, '2021-11-20 22:03:02');
...
INSERT INTO `employees` (`id`, `fullname`, `sex`, `address`, `dob`, `phone`, `email`, `image`) VALUES
(1, 'Lee Min Ho', 1, 'ttt', '2021-11-12 11:16:00', '098345345345', 'clgtqwe12342@gmail.com', '5892c22aac.png');
...
INSERT INTO `feedback` (`id`, `nameuser`, `email`, `comment`, `comment_date`, `product_id`, `status`) VALUES
(1, 'Haha', 'clgt@gmail.com', 'Hay lam ban oi', '2021-11-17 14:29:43', 24, 1),
(2, 'ddaaaaa', 'clgtq@gmail.com', 'A Shiba đẹp quá bạn ơi', '2021-11-17 14:09:31', 24, 1),
(4, 'adddd', 'clgtqwe1@gmail.com', 'hay lắm bạn à', '2021-11-17 14:13:45', 22, 1),
(5, 'eei', 'clgtqwe1323@gmail.com', 'đẹp quá bạn ơi', '2021-11-18 13:16:18', 20, 1),
(6, 'đsddd', 'c@gmail.com', 'tôi tin tưởng sử dụng sản phẩm này', '2021-11-18 13:16:54', 20, 1),
(7, 'aasdddas', 'clgtqwe1@gmail.com', 'đẹp đấy', '2021-11-18 13:20:18', 26, 1),
(8, 'Ni hảo', 'cc@gmail.com', 'đét quá bạn ơi', '2021-11-20 13:55:26', 27, 1),
(9, 'Ác Quỷ Thức Tỉnh', 'cladasd@gmail.com', 'tôi là tôi rất thích sản phẩm này đấy', '2021-11-20 13:57:30', 27, 1),
(11, 'aasdddas', 'clgtqwe1@gmail.com', 'eqqweqweqw', '2021-11-21 07:58:34', 27, 1),
(12, 'sdfsdfsdf', 'clgtqwe1@gmail.com', 'qeqe', '2021-11-26 12:55:31', 24, 0);
...
INSERT INTO `order` (`id`, `fullname`, `email`, `phone`, `address`, `status`, `date_order`, `note`, `total_money`) VALUES
(38, 'Phạm Đức Thịnh', '29aducanhpham@gmail.com', '0989456422', '234 Trương Định', 1, '2021-11-14 17:50:03', 'oke', 242871200),
(39, 'Nguyễn Hoàng Vinh', 'nguyenhoangvinh16112001@gmail.com', '0989456422', '421 Đê La Thành', 0, '2021-11-14 18:11:07', 'Nhanh lên không tao chém', 190854895),
(46, 'aasdddas', 'clgtqwe1@gmail.com', '0989456422', 'zzx', 0, '2021-11-17 17:24:48', '3234', 145000020),
(47, 'Tô Văn Thái A.K.A Jos', 'jostovanthai@gmail.com', '0989456422', 'sdfsdfsdf', 0, '2021-11-21 15:06:54', 'Nhanh Cho Anh', 124421880),
(48, 'aasdddas', 'clgtqwe1@gmail.com', '0989456422', 'zzx', 1, '2021-11-21 15:09:24', 'dfdsfsdfdfsdfs', 251140505);
...
(38, 38, 26, 110450000, 5, 242871200),
(39, 39, 27, 98995000, 5, 190854895),
(50, 46, 29, 138756000, 4, 145000020),
(51, 47, 24, 137940000, 6, 124421880),
(52, 46, 24, 91960000, 4, 251140505),
(53, 48, 24, 91960000, 4, 251140505),
(54, 46, 28, 100495000, 5, 251140505),
(55, 48, 28, 100495000, 5, 251140505),
(56, 46, 27, 59397000, 3, 251140505),
(57, 48, 27, 59397000, 3, 251140505);
...
(2, 'ASUS TUF Gaming F17 FX706HC-HX009T', 21312400, 12, 1, '<p>In these last days it&#39;s so rare to actually hear a song that actually speaks to you. It will become a classic in the slow jam sets. When I first heard it, the sincerity in his voice moved me, then as I listened to the lyrics, it really packs a punch straight</p>\r\n', 1, 'FX706HC-HX009T', 'Intel Core i7-11800H (2.3GHz up to 4.6GHz, 24MB Cache)', '8', 'NVIDIA GeForce RTX 3050 4GB GDDR6', '512GB M.2 NVMe PCIe 3.0 SSD', '17.3inch FHD(1920 x 1080) IPS, Anti-Glare 144Hz', '802.11AX (2X2) ', 1, 'Windows 10 Home bản quyền', 3, 2, 3, 10, 20, '6ae24350eb.jpg', '2021-11-04 10:17:28'),
...
(29, 'Laptop Dell Latitude 7420', 34689000, 10, 5, '<ul>\r\n	<li>CPU: Intel Core i5 1135G7</li>\r\n	<li>RAM: 8GB onboard (kh&ocirc;ng thể n&acirc;ng cấp)</li>\r\n	<li>Ổ cứng: 256GB SSD (hỗ trợ n&acirc;ng cấp thay thế tối đa 2TB)</li>\r\n	<li>VGA: Onboard</li>\r\n	<li>M&agrave;n h&igrave;nh: 14.0 inch FHD</li>\r\n	<li>HĐH: Ubuntu</li>\r\n	<li>M&agrave;u: Đen</li>\r\n</ul>\r\n', 1, '42LT742000', 'Intel Core™ i5 1135G7(2.4Ghz upto 4.2Ghz, 8MB Cache)', '8GB LPDDR4 4266Mhz (onboard) - không thể nâng cấp', 'Intel Iris Xe Graphics', '256GB SSD M2 SATA Class 35 - không có slot trống, nâng cấp thay thế tối đa 2TB', '14.0\" FHD(1920 x 1080)WVA, 220nits, 45%NTSC, xoay gập, cảm ứng', '802.11AX (2X2) ', 1, 'Windows 11 Home bản quyền', 4, 2, 5, 0, 20, '917970a8b2.png', '2021-11-08 08:46:25'),
(30, 'fgfgh', 21312400, 15, 4, '<p>asdafsdfsdf</p>\r\n', 1, 'FX706HC-HX009T', 'Intel® Core™ i7-1165G7 (2.80GHz up to 4.70GHz, 12MB)', '4GB DDR4 2400MHz', 'NVIDIA GeForce RTX 3050 4GB GDDR6', '512GB M.2 NVMe PCIe 3.0 SSD', '17.3inch FHD(1920 x 1080) IPS, Anti-Glare 144Hz', '1 x Thunderbolt 4 support DisplayPort  3 x USB 3', 1, 'Windows 10 Home bản quyền', 2, 2, 5, 0, 29, 'e1c11cd400.jpg', '2021-11-08 12:06:21');
...
(2, 2, '6ae24350eb.jpg', '16374169772d4d141c3a.jpg', 'ewqwqddassd', ''),
...
(24, 29, '917970a8b2.png', '163636118560650_laptop_hp_340s_g7_36a35pa_xam_9.png', 'sdfbsdbfk', 'ádanfiadfn'),
(25, 30, 'e1c11cd400.jpg', '1636373181803c4bdaee.jpg', 'sdffgdhgh', 'easdasd');
...
ALTER TABLE `account`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_account_roles` (`role_id`);
